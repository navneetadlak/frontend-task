                ...
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex">
                                {[1, 2, 3, 4].map((star) => (
                                    <Star key={star} className="h-5 w-5 fill-[#02073E] text-[#02073E]" />
                                ))}
                                <Star className="h-5 w-5 text-[#02073E]"/>
                            </div>
                            <span className="text-sm text-[#02073E]">Trusted by over 4,332 students</span>
                        </div>

                        {/* Main headline */}
                        <div className="space-y-2">
                            <h1 className="text-5xl font-bold leading-tight text-[#02073E] lg:text-6xl xl:text-7xl">Learn Design</h1>
                            <div className="relative inline-block">
                                <h1 className="text-5xl font-bold leading-tight text-[##02073E] lg:text-6xl xl:text-7xl">
                                    with Nia Matos
                                </h1>
                                <div className="absolute -bottom-2 left-40 h-1.5 w-[70%] bg-[#EF9E48] rounded-sm" />
                            </div>
                        </div>

                        {/* Description */}
                        <p className="max-w-lg text-base leading-relaxed text-[#02073E]/70 lg:text-lg">
                    ...
                    <div className="relative">
                        {/* Decorative frame */}
                        <div className="absolute h-full w-full rounded-lg border-2 border-[#EF9E48]/60" />
